...
**Data Reliability**
The data reliability can be assessed using the **Functional_MTIs_in_miRTarDS.xlsx** file, which contains all the Functional MTIs validated via western blot and reporter assays from miRTarBase 2022. miRTarDS accurately recognized **3,883 out of 3,962 MTIs** using my method.
